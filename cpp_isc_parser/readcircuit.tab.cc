...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_GINPUT = 3,                     /* GINPUT  */
  YYSYMBOL_GOUTPUT = 4,                    /* GOUTPUT  */
  YYSYMBOL_GDFF = 5,                       /* GDFF  */
  YYSYMBOL_GNOT = 6,                       /* GNOT  */
  YYSYMBOL_GBUF = 7,                       /* GBUF  */
  YYSYMBOL_GAND = 8,                       /* GAND  */
  YYSYMBOL_GOR = 9,                        /* GOR  */
  YYSYMBOL_GNAND = 10,                     /* GNAND  */
  YYSYMBOL_GNOR = 11,                      /* GNOR  */
  YYSYMBOL_EOLINE = 12,                    /* EOLINE  */
  YYSYMBOL_LPAR = 13,                      /* LPAR  */
  YYSYMBOL_RPAR = 14,                      /* RPAR  */
  YYSYMBOL_COMMA = 15,                     /* COMMA  */
  YYSYMBOL_EQUAL = 16,                     /* EQUAL  */
  YYSYMBOL_NAMESTRING = 17,                /* NAMESTRING  */
  YYSYMBOL_YYACCEPT = 18,                  /* $accept  */
  YYSYMBOL_netlist = 19,                   /* netlist  */
  YYSYMBOL_circuit = 20,                   /* circuit  */
  YYSYMBOL_input_definition = 21,          /* input_definition  */
  YYSYMBOL_output_definition = 22,         /* output_definition  */
  YYSYMBOL_gate_definition = 23,           /* gate_definition  */
  YYSYMBOL_24_1 = 24,                      /* $@1  */
  YYSYMBOL_output = 25,                    /* output  */
  YYSYMBOL_gatename = 26,                  /* gatename  */
  YYSYMBOL_ff_definition = 27,             /* ff_definition  */
  YYSYMBOL_fanin_list = 28,                /* fanin_list  */
  YYSYMBOL_29_2 = 29                       /* $@2  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "GINPUT", "GOUTPUT",
  "GDFF", "GNOT", "GBUF", "GAND", "GOR", "GNAND", "GNOR", "EOLINE", "LPAR",
  "RPAR", "COMMA", "EQUAL", "NAMESTRING", "$accept", "netlist", "circuit",
...
#line 1334 "readcircuit.tab.c"
    break;


#line 1338 "readcircuit.tab.c"
